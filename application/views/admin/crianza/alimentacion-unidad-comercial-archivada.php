<div class="content-wrapper" id="contenido">
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body">
                <div class="container-fluid Vac-1">
                    <div class="row mt-3 Vac-1 text-white justify-content-between ">
                        ...
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                                <a data-toggle="tooltip" data-placement="top" title="Reproductores" class="nav-link " href="<?php echo base_url() ?>Uc" type="button" id="reproduccion">
                                    <span class="Vac-2 fas fa-venus-mars"></span> </a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a data-toggle="tooltip" data-placement="top" title="Engorda" class="nav-link " href="<?php echo base_url() ?>Uen" type="button">
                                    <span class="Vac-2 fas fa-user-graduate"></span> </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-4">
                                ...
                                <table id="table" class="table table-bordered btn-hover">
                                    <thead>
                                        <tr>
                                            <th class="Vac-1 text-white">Usuario</th>
                                            <th class="Vac-1 text-white">Fecha y Hora</th>
                                            <th class="Vac-1 text-white">Cantidad (Gramos)</th>
                                            <th class="Vac-1 text-white">Nombre del Alimento</th>
