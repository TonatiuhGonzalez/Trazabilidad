                    ...
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a data-toggle="tooltip" data-placement="top" title="Reproductores" class="nav-link <?php if ($tipo == 1) echo "active" ?>" href="<?php echo base_url() ?>Uc" type="button" id="reproduccion">
                                ...
                                <span class="Tpfqg-2 fas fa-venus-mars"></span> </a>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a data-toggle="tooltip" data-placement="top" title="Hormonado" class="nav-link  <?php if ($tipo == 2) echo "active" ?>" href="<?php echo base_url() ?>Uccr" type="button" id="crianza">
                                <span class="Tpfqg-2 fas fa-baby-carriage"></span> </a>
                        </li>
                        ...
                        <li class="nav-item ">
                            <a data-toggle="tooltip" data-placement="top" title="Engorda" class="nav-link <?php if ($tipo == 3) echo "active" ?> " href="<?php echo base_url() ?>Uen" type="button">
                                <span class="Tpfqg-2 fas fa-user-graduate"></span> </a>
                        </li>
                ...
                <div class="card-body">
                    <div class="box-body">
                        <div class="row justify-content-first">
                            ...
                            <div class="p-2">
                                <a data-toggle="tooltip" data-placement="top" title="Nuevo Registro" class="btn btn-outline-secondary " href="<?php echo base_url() ?>Tpfqm/<?php echo base64_encode($id_tanque) ?>/<?php echo base64_encode($id_unidad) ?>/<?php echo base64_encode($tipo) ?>" type="button">
                                    <span class="fa fa-plus"></span> <span class="fas fa-temperature-high"></span> </a>
                            </div>
                            <div class="p-2">
