                    ...
                    <div class="card text-center border-info">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-first">
                                ...
                                <div class="p-2" >
                                    <a data-toggle="tooltip" data-placement="top" title="Histórico" class="btn btn-outline-secondary" href="<?php echo base_url()?>Vgurcd" type="button">
                            ...
                            <div  class="row justify-content">
                                <div class="col-md-12 mt-4">                                
                                    <table id="table" class="table table-bordered btn-hover">
                                        <thead>
                                            <tr> 
                                                <th class="Vgurc-1 text-white">Identificador Único Logístico</th>                                           
                                                <th class="Vgurc-1 text-white">Fecha Recepción</th>
