<div class="content-wrapper" id="contenido" >
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body" >
                <div class="container-fluid Vtrenc-1">
                    <div class="row mt-3 Vtrenc-1 text-white justify-content-between ">
                ...
                <div class="card text-center border-info">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item" >
                                ...
                                <span class="Vtrenc-2 fas fa-venus-mars" ></span> </a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a data-toggle="tooltip" data-placement="top" title="Engorda" class="nav-link " href="<?php echo base_url()?>Uen" type="button">
                                    <span class="Vtrenc-2 fas fa-user-graduate" ></span> </a>
                            </li>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-first">
                            ...
                            <div class="p-2" >
                                <a data-toggle="tooltip" data-placement="top" title="Regresar" class="btn btn-outline-secondary" href="<?php echo base_url()?>Venc/<?php echo base64_encode($uc->Id_unidad_creada_crianza) ?>/<?php echo base64_encode($id_ul[0]->{'Id_unidad_enviada'})?>" type="button">
                        ...
                        <div  class="row">
                            <div class="col-md-12 mt-4">
                                ...
                                <table id="table" class="table table-bordered btn-hover">
                                    <thead>
                                        <tr> 
                                            <th class="Vtrenc-1 text-white">Nombre insumo</th>
                                            <th class="Vtrenc-1 text-white">Cantidad Utilizada</th>                               
                                            <th class="Vtrenc-1 text-white">Fecha y Hora </th>                               
