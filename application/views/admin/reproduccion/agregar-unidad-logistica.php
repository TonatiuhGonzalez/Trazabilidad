<div class="content-wrapper" id="contenido">
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body">
                <div class="container-fluid Venvur-1">
                    <div class="row mt-3 Venvur-1 text-white justify-content-first ">
                ...
                <form action="<?php echo base_url() ?>Aenvur" method="POST"  onsubmit="$('#submitBtn').prop('disabled', true); ">
                    <div class="form-group">
                        ...
                        <input disabled type="text" class="form-control" value="<?php
                                                                                ...
                                                                                if (count($identificadores) <=1) {
                                                                                        ...
                                                                                        $ni='L'.date('ym').'1'.$n.$this->session->userdata('identificador_unico');                                                                                        
                                                                                        echo $ni ;
                                                                                    // echo 'heloo';
                                                                                } else {
                                                                                    $rep = 0;
