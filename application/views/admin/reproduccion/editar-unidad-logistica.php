                        ...
                        <table id="table" class="table table-bordered table-responsive-md table-striped text-center ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="Vela-1 text-center text-white">Identificador único comercial</th>
                                    <th class="Vela-1 text-center text-white">Número de desove</th>                                   
                                    <th class="Vela-1 text-center text-white">Número de alevines</th>                                   
