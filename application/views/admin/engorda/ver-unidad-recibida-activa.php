<div class="content-wrapper" id="contenido">
        <section class="content">
                <div class="mt-2 ml-1 mr-1">
                        <div class="box-body">
                                <div class="container-fluid Vvure-1 ">
                                        <div class="row mt-3 Vvure-1  text-white justify-content-between ">
                                ...
                                <div class="row justify-content-first">
                                        <div class="p-2 ">
                                                <a data-toggle="tooltip" data-placement="top" title="Regresar" href="<?php echo base_url() ?>Vure" class="btn btn-outline-secondary ">
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="col">
                                                ...
                                                <input min="1" type="number" step="0.3" class="form-control" value="<?php echo $unidad->Ur_kilogramos ?>" disabled>
