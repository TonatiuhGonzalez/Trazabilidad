<div class="content-wrapper" id="contenido" >
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body" >
                <div class="container-fluid Vlimarc-1">
                    <div class="row mt-3 Vlimarc-1 text-white justify-content-first ">
                        ...
                        <div  class="row">
                            <div class="col-md-12 mt-4">
                                ...
                                <table id="table" class="table table-bordered btn-hover">
                                    <thead>
                                        <tr> 
                                            <th class="Vlimarc-1 text-white">Usuario</th>
                                            <th class="Vlimarc-1 text-white">Fecha Limpieza</th>                                    
