<div class="content-wrapper" id="contenido" >
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body" >
                <div class="container-fluid Venc-1">
                    <div class="row mt-3 Venc-1 text-white justify-content-between ">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item" >
                                ...
                                <span class="Venc-2 fas fa-venus-mars" ></span> </a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a data-toggle="tooltip" data-placement="top" title="Engorda" class="nav-link " href="<?php echo base_url()?>Uen" type="button">
                                    <span class="Venc-2 fas fa-user-graduate" ></span> </a>
                            </li>
                        ...
                        <div  class="row">
                            <div class="col-md-12 mt-4">
                                ...
                                <table id="table" class="table table-bordered btn-hover">
                                    <thead>
                                        <tr> 
                                            <th class="Venc-1 text-white">Nombre Enfermedad</th>
                                            <th class="Venc-1 text-white">Fecha y Hora de Inicio</th>                               
                                            <th class="Venc-1 text-white">Fecha y Hora de Termino</th>                               
                                            <th class="Venc-1 text-white">Opciones</th>                               
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <div class="btn-group" >
                                                        ...
                                                        href="<?php echo base_url()?>Vtrenc/<?php echo base64_encode($tanque->Id_enfermedad_crianza)?>/<?php echo base64_encode($id_uar)?>/<?php echo base64_encode($id_ul[0]->Id_unidad_enviada)?>" >                                                
