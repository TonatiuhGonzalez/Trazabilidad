<div class="content-wrapper" id="contenido">
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body">
                <div class="container-fluid Vlucear-1">
                    <div class="row mt-3 Vlucear-1 text-white justify-content-between ">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-4">
                                ...
                                <table id="table" class="table table-bordered btn-hover">
                                    <thead>
                                        <tr>
                                            <th class="Vlucear-1 text-white">Usuario</th>
                                            <th class="Vlucear-1 text-white">Fecha Limpieza</th>
