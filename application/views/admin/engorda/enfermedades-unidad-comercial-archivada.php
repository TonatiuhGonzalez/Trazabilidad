<div class="content-wrapper" id="contenido">
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body">
                <div class="container-fluid Venfucear-1">
                    <div class="row mt-3 Venfucear-1 text-white justify-content-between ">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-4">
                                ...
                                <table id="table" class="table table-bordered btn-hover">
                                    <thead>
                                        <tr>
                                            <th class="Venfucear-1 text-white">Nombre Enfermedad</th>
                                            <th class="Venfucear-1 text-white">Fecha y Hora de Inicio</th>
                                            <th class="Venfucear-1 text-white">Fecha y Hora de Termino</th>
                                            <th class="Venfucear-1 text-white">Opciones</th>
                                    ...
                                    <tbody id="cuerpotabla">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <div class="btn-group">
                                                            <a data-toggle="tooltip" data-placement="top" title="Tratamientos" type="button" class="btn btn-outline-secondary" href="<?php echo base_url() ?>Vtratucear/<?php echo base64_encode($tanque->Id_enfermedad_engorda) ?>/<?php echo base64_encode($id_uar) ?>/<?php echo base64_encode($id_ul[0]->Id_unidad_enviada)?>">
