                ...
                <div class="container-fluid">
                        <div class="mt-2 ml-1 mr-1">
                                ...
                                <div class="row justify-content-end">
                                        <div class="p-2 ml-5">
                                                <a data-toggle="tooltip" data-placement="top" title="Regresar" href="<?php echo base_url() ?>Hs" class="btn  btn-outline-secondary ">
                                                        <span class="fas fa-arrow-alt-circle-left"></span>
                                                </a>

                                        </div>
                                        <div class="p-2 ml-5">
                                                <a data-toggle="tooltip" data-placement="top" title="Reactivar" href="<?php echo base_url() ?>Reacs/<?php echo $socio->Id_socio ?>" class="btn  btn-outline-secondary mr-5 ml-5">
