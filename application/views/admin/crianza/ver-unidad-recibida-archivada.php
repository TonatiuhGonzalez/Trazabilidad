        ...
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body">
                ...
                <div class="row justify-content-first">
                    <div class="p-2 ">
                        <a data-toggle="tooltip" data-placement="top" title="Regresar" href="<?php echo base_url() ?>Vgurcd" class="btn btn-outline-secondary ">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <select disabled class="form-control" id="exampleFormControlSelect1">
                            <option value="<?php echo $unidades[0]->{'Id_socio'} ?>"><?php echo $unidades[0]->{'Soc_nombre'} ?>
                            </option>
                        </select>
                    </div>
                    <div class="col">
                    ...
                    <table class="table table-bordered table-responsive-md table-striped text-center  mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="Vvurc-1 text-white">Identificador único comercial </th>
                                <th class="Vvurc-1 text-white">Porcentaje </th>
                                <th class="Vvurc-1 text-white">kilogramos </th>
