<div class="content-wrapper" id="contenido">
    <section class="content">
        <div class="mt-2 ml-1 mr-1">
            <div class="box-body">
                <div class="container-fluid Vaul-1">
                    <div class="row mt-3 Vaul-1 text-white justify-content-between ">
                ...
                <form action="<?php echo base_url() ?>Aauec" method="POST" onsubmit="$('#submitBtn').prop('disabled', true); ">
                    <div class="form-group">
                        ...
                        <input disabled type="text" class="form-control" value="<?php
                                                                                if (count($identificadores )<= 1) {
                                                                                    ...
                                                                                    $ni = 'L' . date('ym') . '2' . $n . $this->session->userdata('identificador_unico');
                                                                                    echo $ni;
                                                                                } else {
                                                                                    $rep = 0;
                    ...
                    <div class="form-group">
                        <input type="hidden" name="ncselect" id='ncselect' required="true">
                    </div>
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="p-2 ml-5">
                            <button  data-toggle="tooltip" data-placement="top" title="Registrar" type="submit" class="btn btn-outline-secondary mr-5 ml-5" id="submitBtn">
